...
@static if !isdefined(Base, :get_extension)
    function __init__()
        @require Measurements="eff96d63-e80a-5855-80a2-b1b0885c5ab7" begin
            include("../ext/DiffEqBaseMeasurementsExt.jl")
        end

        @require MonteCarloMeasurements="0987c9cc-fe09-11e8-30f0-b96dd679fdca" begin
            include("../ext/DiffEqBaseMonteCarloMeasurementsExt.jl")
        end

        @require Unitful="1986cc42-f94f-5a68-af5c-568840ba703d" begin
            include("../ext/DiffEqBaseUnitfulExt.jl")
        end

        @require GeneralizedGenerated="6b9d7cbe-bcb9-11e9-073f-15a7a543e2eb" begin
            include("../ext/DiffEqBaseGeneralizedGeneratedExt.jl")
        end

        @require Tracker="9f7883ad-71c0-57eb-9f7f-b5c9e6d3789c" begin
            include("../ext/DiffEqBaseTrackerExt.jl")
        end

        @require ReverseDiff="37e2e3b7-166d-5795-8a7a-e32c996b4267" begin
            include("../ext/DiffEqBaseReverseDiffExt.jl")
        end

        @require Zygote="e88e6eb3-aa80-5325-afca-941959d7151f" begin
            include("../ext/DiffEqBaseZygoteExt.jl")
        end
