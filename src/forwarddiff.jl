...
function anyeltypedual(x)
    if propertynames(x) === ()
        ...
        mapreduce(y -> !isdefined(x, y) ? Any : anyeltypedual(getproperty(x, y)),
...
function anyeltypedual(x::Union{Array{T}, AbstractArray{T}, Set{T}}) where {
                                                                            T <:
                                                                            Union{Number,
                                                                                  Symbol,
                                                                                  String}}
...
function anyeltypedual(x::Union{Array{T}, AbstractArray{T}, Set{T}}) where {N,
                                                                            T <: Union{
                                                                                  AbstractArray{
                                                                                                <:Number
                                                                                                },
