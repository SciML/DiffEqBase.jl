...
@test solve(prob_nojac,
            Rosenbrock23(autodiff = false, diff_type = Val{:central})).retcode == ReturnCode.Success
@test solve(prob_nojac,
            Rosenbrock23(autodiff = false, diff_type = Val{:complex})).retcode == ReturnCode.Success
